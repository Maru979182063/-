...
def normalize_sentence_fill_constraints(payload: dict[str, Any] | None) -> dict[str, Any]:
    ...
    normalized["blank_position"] = normalize_sentence_fill_blank_position(payload.get("blank_position") or payload.get("position"))
    normalized["function_type"] = normalize_sentence_fill_function_type(payload.get("function_type"))
    normalized["logic_relation"] = normalize_sentence_fill_logic_relation(payload.get("logic_relation"))
    return normalized
